...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-between mb-5">
      <div>
        <AboutMe name={'Elisabeth Erkekoglou'} role={'Junior Frontend Developer'} availability={'open'} location={'Germany'} email={'elisabeth.erkekoglou@gmail.com'} image={''} currrentCompany={{
          name: 'Arvato SE',
